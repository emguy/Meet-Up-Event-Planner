...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainContainer = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6);
	var EventListContainer = __webpack_require__(165);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "header",
	        null,
	        " this is my header blah blah blah "
	      ),
	      React.createElement(
	        "main",
	        null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEntry = React.createClass({
	  ...
	  displayEventDetail: function displayEventDetail() {
	  ...
	  closeEventDetail: function closeEventDetail() {
	    if (this.state.showDetail) {
	  ...
	  render: function render() {
	    var eventDetail;
	    if (this.state.showDetail) {
	      eventDetail = React.createElement(EventBox, { event: this.props.event, closeMe: this.closeEventDetail });
	    };
	    return React.createElement(
	      "li",
	...
	var EventBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      { className: "modal", onClick: this.props.closeMe },
	      React.createElement(
	        "div",
	        ...
	        React.createElement(ModalHeader, { eventName: this.props.event.name, eventTime: this.props.event.startTime }),
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          "a",
	          { type: "button", className: "event-button", href: "#" },
	          " ",
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          { className: "event-value" },
	          " ",
	          new Date(this.props.event.endTime).toLocaleString(),
	          " "
	        )
	      ),
	      React.createElement(
