...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppContainer = __webpack_require__(230);
	var LoginContainer = __webpack_require__(261);
	var EventListContainer = __webpack_require__(255);
	var NewEventContainer = __webpack_require__(262);

	/* import redux and react-redux */
	var Redux = __webpack_require__(237);
	var applyMiddleware = __webpack_require__(237).applyMiddleware;
	var Provider = __webpack_require__(231).Provider;

	var storageManager = __webpack_require__(263);
	var reducer = __webpack_require__(265);
	var pushToSessionStorage = __webpack_require__(268);
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(Route, { path: "/events", component: EventListContainer }),
	      React.createElement(Route, { path: "/new_event", component: NewEventContainer })
	    )
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../opt/npm/lib/node_modules/css-loader/index.js!./../../../../opt/npm/lib/node_modules/sass-loader/index.js!./style.scss", function() {
				var newContent = require("!!./../../../../opt/npm/lib/node_modules/css-loader/index.js!./../../../../opt/npm/lib/node_modules/sass-loader/index.js!./style.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box; }\n\nmain {\n  padding: 30px 0 270px 0; }\n  @media (min-width: 800px) {\n    main {\n      padding-bottom: 150px; } }\n\n.button {\n  border-radius: 5px;\n  -moz-border-radius: 5px;\n  -webkit-border-radius: 5px;\n  display: inline-block;\n  color: #FFFFFF;\n  border: 1px #FFFFFF solid;\n  text-align: center;\n  width: 50px;\n  height: 40px;\n  line-height: 36px;\n  font-size: 1.2rem;\n  margin-right: 20px; }\n  .button:hover {\n    background-color: #43c4ef; }\n  .button .tooltip-text {\n    padding: 0;\n    line-height: 30px;\n    font-size: 0.8rem; }\n\na {\n  text-decoration: none; }\n  a:visited {\n    color: #FFFFFF; }\n  a:hover {\n    text-decoration: underline; }\n\nul {\n  list-style-type: none; }\n\nform {\n  margin: auto;\n  max-width: 600px;\n  border: 1px #15B5EA solid;\n  box-shadow: 3px 3px 0px #BBB;\n  padding: 50px 40px 50px 40px; }\n  form label {\n    margin: auto;\n    color: #222222; }\n    form label span {\n      display: inline-block;\n      width: 20%;\n      min-width: 120px;\n      margin-bottom: 5px; }\n    form label input {\n      display: inline-block;\n      min-width: 300px;\n      width: 75%;\n      margin-bottom: 10px; }\n\nhtml, body {\n  height: 100%;\n  color: #FFFFFF; }\n\n.color-reversed {\n  background-color: #15B5EA; }\n\n.form-button-list {\n  margin-top: 20px; }\n  .form-button-list .form-button {\n    font-size: 0.8rem;\n    width: 80px;\n    height: 40px;\n    line-height: 40px; }\n\n#root {\n  height: 100%;\n  font: 100% \"Open Sans\", sans-serif; }\n\n.container {\n  position: relative;\n  min-height: 100%; }\n\n#menu-button {\n  position: absolute;\n  left: 20px;\n  top: 56px;\n  z-index: 1; }\n\n#header-content {\n  position: relative;\n  width: 100%;\n  background-color: #1091BC;\n  height: 120px; }\n  #header-content h1 {\n    width: 400px;\n    position: absolute;\n    left: 120px;\n    bottom: 25px;\n    text-shadow: #e0e0e0 1px 1px 0;\n    opacity: 0.9; }\n    @media (max-width: 800px) {\n      #header-content h1 {\n        left: 90px;\n        font-size: 1.4rem; } }\n\n#nav-content {\n  background-color: #0f7fa4;\n  width: 200px;\n  color: #FFFFFF; }\n  #nav-content ul {\n    margin-top: 31px; }\n    #nav-content ul .nav-button {\n      line-height: 50px;\n      font-size: 1.1rem;\n      height: 50px;\n      padding-left: 15px; }\n      #nav-content ul .nav-button:hover {\n        background-color: #2cbcec; }\n\n#footer-content {\n  position: absolute;\n  bottom: 0;\n  width: 100%;\n  background-color: #1091BC;\n  min-height: 220px;\n  padding: 20px 5px 20px 20px; }\n  @media (min-width: 800px) {\n    #footer-content {\n      min-height: 120px; } }\n  #footer-content > p {\n    padding-left: 10px;\n    margin-left: 75px;\n    border-left: 1px #FFFFFF solid;\n    font-size: .8rem; }\n  #footer-content #react-logo {\n    float: left; }\n    #footer-content #react-logo img {\n      width: 60px; }\n    #footer-content #react-logo .react-text {\n      visibility: hidden;\n      text-align: center;\n      font-size: 0.8rem; }\n    #footer-content #react-logo:hover .react-text {\n      visibility: visible; }\n\n.event-list {\n  width: 100%; }\n  @media (min-width: 800px) {\n    .event-list {\n      width: 800px;\n      margin: auto; } }\n  .event-list .event {\n    border-radius: 10px;\n    -moz-border-radius: 10px;\n    -webkit-border-radius: 10px;\n    margin-left: 5px;\n    margin-right: 5px;\n    padding: 20px 30px 20px 30px;\n    background-color: #15B5EA; }\n    .event-list .event:not(:last-child) {\n      margin-bottom: 20px; }\n    .event-list .event:hover {\n      background-color: #73d3f2; }\n    .event-list .event .event-name {\n      white-space: nowrap;\n      overflow: hidden;\n      margin: 0 0 10px 0;\n      font-size: 1.3rem;\n      font-weight: 700; }\n    .event-list .event .event-time {\n      font-size: 1.1rem; }\n\n.event-card {\n  z-index: 1;\n  background-color: rgba(0, 0, 0, 0.4); }\n  .event-card .modal-body {\n    border-radius: 10px;\n    -moz-border-radius: 10px;\n    -webkit-border-radius: 10px;\n    position: fixed;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    -moz-transform: translate(-50%, -50%);\n    -webkit-transform: translate(-50%, -50%);\n    background-color: #15B5EA;\n    padding: 0px;\n    margin: auto;\n    width: 800px; }\n    @media (max-width: 800px) {\n      .event-card .modal-body {\n        width: 100%; } }\n    .event-card .modal-body .modal-close {\n      font-size: 2rem;\n      position: absolute;\n      right: 26px;\n      top: 16px;\n      color: #cccccc; }\n      .event-card .modal-body .modal-close:hover {\n        color: #FFFFFF; }\n    .event-card .modal-body .event-header {\n      padding: 15px 20px 15px 20px;\n      height: 90px; }\n      .event-card .modal-body .event-header .event-name {\n        margin-bottom: 5px; }\n        @media (max-width: 800px) {\n          .event-card .modal-body .event-header .event-name {\n            overflow: hidden;\n            max-width: 300px; } }\n    .event-card .modal-body .event-footer {\n      height: 90px; }\n      .event-card .modal-body .event-footer ul {\n        float: right;\n        margin-top: 20px;\n        margin-right: 20px; }\n    .event-card .modal-body .event-content {\n      font-size: 1.1rem;\n      padding: 10px 20px 10px 20px;\n      margin: 0;\n      background-color: white; }\n    .event-card .modal-body .event-attribute:not(:first-child) {\n      margin-top: 16px; }\n    .event-card .modal-body .event-attribute p {\n      color: black; }\n    .event-card .modal-body .event-attribute .event-label {\n      font-weight: 700; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6);
	var ReactRedux = __webpack_require__(231);
	var Router = __webpack_require__(171);
	var Button = __webpack_require__(254);
	var Link = __webpack_require__(171).Link;
	var EventListContainer = __webpack_require__(255);
	var actionsUI = __webpack_require__(259);
	var actionsSession = __webpack_require__(260);
	...
	var App = React.createClass({
	  ...
	  /* the render method */render: function render() {
	    var menuButton;

	    if (this.props.isLoggedIn) {
	      menuButton = React.createElement(
	        Button,
	        { id: "menu-button", tooltip: "Options",
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(NavMenu, { visible: this.props.navMenuIsVisible, doLogout: this.props.doLogout })
	      ),
	      React.createElement(
	        "header",
	        { onClick: this.props.hideNavMenu },
	        React.createElement(HeaderContent, { menuButtonAction: this.props.unhideNavMenu })
	      ),
	      React.createElement(
	        "main",
	        { onClick: this.props.hideNavMenu },
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    unhideNavMenu: function unhideNavMenu(e) {
	      return dispatch(actionsUI.unhideNavMenu());
	    },
	    hideNavMenu: function hideNavMenu(e) {
	      e.stopPropagation();
	...
	var NavMenu = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "div",
	      { id: "nav-content", style: this.defaultStyle },
	      React.createElement(
	        "ul",
	        { role: "nav" },
	        React.createElement(
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        { id: "react-logo" },
	        React.createElement("img", { src: "img/react_logo.png", alt: "react logo" }),
	        React.createElement(
	          "p",
	      ...
	      React.createElement(
	        "p",
	        null,
	        "This is the first project of Udacity's nano degree program for senior web developer. It emphasizes on the design of the HTML forms. All user event data is stored locally by the browser. The complete source files can be downloaded from",
	        React.createElement(
	          "a",
	          { href: "http://github.com/emguy/Meet-Up-Event-Planner" },
	          "my github"
	        ),
	        ".",
	        ...
	        " ",
	        React.createElement("br", null),
	        "Created by Yu Zhang | All right reserved ",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Button = React.createClass({
	  ...
	  unhideTooltip: function unhideTooltip() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactRedux = __webpack_require__(231);
	var React = __webpack_require__(6);
	var EventEntryContainer = __webpack_require__(256);
	var Router = __webpack_require__(171);
	...
	var EventList = React.createClass({
	  ...
	  render: function render() {
	    var parsedEvents = this.props.data.slice(0, 5).map(function (item) {
	      return React.createElement(EventEntryContainer, { key: item.key, event: item });
	    });
	    return React.createElement(
	      "ul",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6);
	var ReactRedux = __webpack_require__(231);
	var EventCard = __webpack_require__(257);
	var setActiveEvent = __webpack_require__(259).setActiveEvent;
	var unsetActiveEvent = __webpack_require__(259).unsetActiveEvent;
	...
	var EventEntry = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "li",
	      { className: "event", onClick: this.props.unhideEventCard },
	      React.createElement(
	        "p",
	      ...
	      React.createElement(EventCard, { visible: this.props.EventCardIsVisible, event: this.props.event,
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    unhideEventCard: function unhideEventCard(e) {
	      e.stopPropagation();
	      return dispatch(setActiveEvent(ownProps.event.key));
	    },
	    hideEventCard: function hideEventCard(e) {
	      e.stopPropagation();
	      return dispatch(unsetActiveEvent());
	    }
	  };
	};
	var EventEntryContainer = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(EventEntry);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventCard = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      Modal,
	      { className: "event-card", visible: this.props.visible,
	        closeMe: this.props.closeMe },
	      React.createElement(ModalHeader, { eventName: this.props.event.name,
	        eventTime: this.props.event.startTime }),
	      React.createElement(ModalContent, { event: this.props.event }),
	...
	var Modal = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        { className: "modal-body", onClick: function onClick(e) {
	            if (e) {
	              e.stopPropagation();
	            }
	          } },
	        React.createElement(
	          "div",
	          { className: "modal-close", onClick: this.props.closeMe },
	          " ✖ "
	        ),
	        this.props.children
	      )
...
/***/ function(module, exports) {
	 ...
	 */
	var setActiveEvent = function setActiveEvent(key) {
	 ...
	 * @arg key{number} the unique key of the event object
	 */
	var unsetActiveEvent = function unsetActiveEvent(key) {
	 ...
	 */
	var unhideNavMenu = function unhideNavMenu() {
...
/***/ function(module, exports) {
	 ...
	 */
	var setLogin = function setLogin(uid) {
	 ...
	 */
	var unsetLogin = function unsetLogin() {
	 ...
	 */
	var resetSession = function resetSession(data) {
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement("input", { type: "text", id: "user-id", placeholder: "" })
	        ),
	        React.createElement("br", null),
	        React.createElement(
	          "label",
	          ...
	          React.createElement("input", { type: "text", id: "password", placeholder: "" })
	        ),
	        React.createElement(
	          "div",
	          ...
	          React.createElement(
	            Button,
	            { className: "color-reversed form-button" },
	            " login "
	          ),
	          React.createElement(
	            Button,
	          ...
	          React.createElement(
	            Button,
	            { className: "color-reversed form-button", action: this.props.handleLogin },
	            " Try "
	          )
	        )
	      )
	...
	var LoginContainer = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(Login);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventCreatorContainer = React.createClass({
	  displayName: "EventCreatorContainer",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var preloadedEvents = __webpack_require__(264);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducerUI = __webpack_require__(266);
	var reducerSession = __webpack_require__(267);
	...
	var reducerKey = function reducerKey(state) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var reducerUI = function reducerUI(state, action) {
	  switch (action.type) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducerSession = function reducerSession(state, action) {
	  switch (action.type) {
	    case RESET_SESSION:
	      if (action.operand) {
...
/***/ function(module, exports) {
	...
	var pushToSessionStorage = function pushToSessionStorage(store) {
