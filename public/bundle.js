...
/***/ function(module, exports, __webpack_require__) {
	...
	var sessionManager = __webpack_require__(6);
	var preloadedEvents = __webpack_require__(7) || [];

	var React = __webpack_require__(8);
	var ReactDOM = __webpack_require__(165);
	var MainContainer = __webpack_require__(166);
	...
	var LoginContainer = __webpack_require__(230);
	var EventListContainer = __webpack_require__(167);
	var EventCreatorContainer = __webpack_require__(231);
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(
	    ...
	    React.createElement(Route, { path: "/new_event", component: EventCreatorContainer })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(8);
	var EventListContainer = __webpack_require__(167);
	var Button = __webpack_require__(171).Button;
	...
	var MainContainer = React.createClass({
	  ...
	  unhideNavMenu: function unhideNavMenu() {
	  ...
	  hideNavMenu: function hideNavMenu() {
	    if (this.state.navMenuIsVisible) {
	  ...
	  /* the render method */render: function render() {
	    return React.createElement(
	      "div",
	      { className: "container", onClick: this.hideNavMenu },
	      React.createElement(
	        Button,
	        { id: "menu-button", tooltip: "Options",
	          action: this.unhideNavMenu },
	        "☰"
	      ),
	      React.createElement(NavMenu, { visible: this.state.navMenuIsVisible }),
	      React.createElement(HeaderContainer, { menuButtonAction: this.unhideNavMenu }),
	      React.createElement(
	        "main",
	        null,
	        " ",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventCard = __webpack_require__(170);
	...
	var EventList = React.createClass({
	  ...
	  render: function render() {
	    var parsedEvents = this.props.data.slice(0, 5).map(function (item, index) {
	      return React.createElement(EventEntry, { key: index.toString(), event: item });
	    });
	    return React.createElement(
	      "ul",
	...
	var EventEntry = React.createClass({
	  ...
	  unhideDetail: function unhideDetail() {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "li",
	      { className: "event", onClick: this.unhideDetail },
	      React.createElement(
	        "p",
	      ...
	      React.createElement(EventCard, { visible: this.state.EventBoxIsVisible, event: this.props.event,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(8);
	var Modal = __webpack_require__(171).Modal;
	var Button = __webpack_require__(171).Button;
	...
	var Modal = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        { className: "modal-body", onClick: utils.doNothing },
	        React.createElement(
	          "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginContainer = React.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    console.log(_typeof(sessionManager.isLoggedIn()));
