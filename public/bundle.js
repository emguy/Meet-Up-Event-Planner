...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEntry = React.createClass({
	  ...
	  render: function render() {
	    var eventDetail;
	    if (this.state.showDetail) {
	      eventDetail = React.createElement(EventDetail, { event: this.props.event, closeMe: this.closeEventDetail });
	    };
	    return React.createElement(
	      "li",
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "span",
	            { className: "glyphicon glyphicon-remove", "aria-hidden": "true", onClick: this.props.closeMe },
	            " "
	          )
	        ),
	        React.createElement(
