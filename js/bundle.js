...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventListContainer = __webpack_require__(159);

	React.render(React.createElement(EventListContainer, null), document.getElementById("root"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEntry = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "li",
	      { className: _className, onClick: this.displayEventDetail },
	      React.createElement(
	        "p",
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement("span", { className: "glyphicon glyphicon-remove close",
	          "aria-hidden": "true", onClick: this.props.closeMe }),
	        React.createElement(
	          "p",
	          { className: "event-name" },
	          this.props.event.name
